...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="sheen fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center bg-[var(--color-red)] shadow-[0_12px_34px_rgba(0,0,0,0.35)] transition-transform hover:scale-105"
    >
